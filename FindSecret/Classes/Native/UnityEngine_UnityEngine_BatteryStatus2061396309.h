...
struct  BatteryStatus_t2061396309 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(BatteryStatus_t2061396309, ___value___1)); }
