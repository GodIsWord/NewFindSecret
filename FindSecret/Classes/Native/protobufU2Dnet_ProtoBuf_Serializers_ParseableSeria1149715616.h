...
struct  ParseableSerializer_t1149715616  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_parse_0() { return static_cast<int32_t>(offsetof(ParseableSerializer_t1149715616, ___parse_0)); }
