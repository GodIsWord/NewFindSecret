...
struct  CustomDataModule_t2135829708 
{
public:
...
public:
	inline static int32_t get_offset_of_m_ParticleSystem_0() { return static_cast<int32_t>(offsetof(CustomDataModule_t2135829708, ___m_ParticleSystem_0)); }
...
struct CustomDataModule_t2135829708_marshaled_pinvoke
{
	ParticleSystem_t1800779281 * ___m_ParticleSystem_0;
};
// Native definition for COM marshalling of UnityEngine.ParticleSystem/CustomDataModule
struct CustomDataModule_t2135829708_marshaled_com
{
	ParticleSystem_t1800779281 * ___m_ParticleSystem_0;
};
