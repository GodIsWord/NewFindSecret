...
struct  ParticleSystemVertexStream_t2433380720 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ParticleSystemVertexStream_t2433380720, ___value___1)); }
