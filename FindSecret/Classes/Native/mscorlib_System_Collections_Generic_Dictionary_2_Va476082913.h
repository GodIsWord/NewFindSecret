...
struct  ValueCollection_t476082913  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_dictionary_0() { return static_cast<int32_t>(offsetof(ValueCollection_t476082913, ___dictionary_0)); }
