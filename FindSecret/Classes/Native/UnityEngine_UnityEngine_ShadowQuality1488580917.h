...
struct  ShadowQuality_t1488580917 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ShadowQuality_t1488580917, ___value___1)); }
