...
struct  ProtoDecoratorBase_t1230695942  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_Tail_0() { return static_cast<int32_t>(offsetof(ProtoDecoratorBase_t1230695942, ___Tail_0)); }
